...
class DeviceHealthTest extends TestCase
{
    ...
    /**
     * Test service queries device health for door.
     */
    public function test_health_service_queries_door(): void
    {
        $door = Door::firstOrCreate(
            ['door_id' => 'DOOR-A'],
            [
                'name' => 'Test Door A',
        ...
        $health = $this->service->getHealthForDoor($door);
        
        $this->assertInstanceOf(DeviceHealth::class, $health);
        $this->assertIsArray($health->capabilities);
    }
}
