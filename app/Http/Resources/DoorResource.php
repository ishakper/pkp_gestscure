...
class DoorResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'normalized_health_status' => strtolower((string) ($this->health_status ?: ($this->connection_status ?? $this->status ?? 'offline'))),
            'remote_unlock_allowed' => $this->remoteUnlockAllowed(),
            'remote_unlock_unavailable_reason' => $this->remoteUnlockAllowed() ? null : 'Terminal belum terhubung atau sedang maintenance.',
